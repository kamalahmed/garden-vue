<template>
  ...
  <section
    class="choose-area pt-24 relative z-1 text-white testimonial-area nav-carousel bg-fixed bg-no-repeat bg-cover lg:-mt-space14 md:-mt-space0 lg:pt-space15 md:pt-space5 pb-space8 text-center"
