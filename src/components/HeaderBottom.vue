<template>
  <div class="header-menu-content bg-white z-40">
    <div
      class="lg:max-w-desktop lg:w-full m-auto lg:px-8 md:max-w-full sm:max-w-full md:px-4 sm:px-4 main-header-container"
    >
      <!-- START NAVBAR -->
      <div>
        <div
